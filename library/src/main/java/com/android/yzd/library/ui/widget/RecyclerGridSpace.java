...
/**
 * <p>Title:        RecyclerGridSpace
 * <p>Description:
 * <p>@author:      yezd
 * <p>Copyright:    Copyright (c) 2010-2017
 * <p>Company:      @咪咕动漫
 * <p>Create Time:  2017/8/23 下午11:15
 * <p>@author:
 * <p>Update Time:
 * <p>Updater:
 * <p>Update Comments:
 */
public class RecyclerGridSpace extends RecyclerView.ItemDecoration {
    private int space;  
    private int color = -1;  
    ...
    public RecyclerGridSpace(int space) {
        this.space = space;  
    }  
  
    public RecyclerGridSpace(int space, int color) {
        this.space = space;  
        this.color = color;  
    ...
    public RecyclerGridSpace(int space, int color, int type) {
        this.space = space;  
        this.color = color;  
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);  
        mPaint.setColor(color);  
    ...
    public RecyclerGridSpace(int space, Drawable mDivider) {
        this.space = space;  
